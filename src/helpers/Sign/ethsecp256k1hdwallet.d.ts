 ...
 */
export interface EthSecp256k1HdWalletSerialization {
    ...
    /** An instance of EthSecp256k1HdWalletData, which is stringified, encrypted and base64 encoded. */
    readonly data: string;
}
export declare function extractKdfConfiguration(serialization: string): KdfConfiguration;
export interface EthSecp256k1HdWalletOptions {
...
interface EthSecp256k1HdWalletConstructorOptions extends Partial<EthSecp256k1HdWalletOptions> {
...
export declare class EthSecp256k1HdWallet implements OfflineDirectSigner {
     ...
     */
    static fromMnemonic(mnemonic: string, options?: Partial<EthSecp256k1HdWalletOptions>): Promise<EthSecp256k1HdWallet>;
    /**
     ...
     * @param options An optional `EthSecp256k1HdWalletOptions` object optionally containing a bip39Password, hdPaths, and prefix.
     */
    static generate(length?: 12 | 15 | 18 | 21 | 24, options?: Partial<EthSecp256k1HdWalletOptions>): Promise<EthSecp256k1HdWallet>;
    /**
     ...
     */
    static deserialize(serialization: string, password: string): Promise<EthSecp256k1HdWallet>;
    /**
     * Restores a wallet from an encrypted serialization.
     *
     ...
     */
    static deserializeWithEncryptionKey(serialization: string, encryptionKey: Uint8Array): Promise<EthSecp256k1HdWallet>;
